...
if User_menu == 'Medal Tally':
    ...
    if Selected_year == 'Overall' and Selected_country != 'Overall':
        st.title(Selected_country + " Overall perfromance")
    if Selected_year != 'Overall' and Selected_country != 'Overall':
...
if User_menu == 'Overall Analysis':
    ...
    athlete_over_time = helper.data_nations_over_time(df, 'Name')
...
if User_menu == 'Athlete wise Analysis':
    ...
    #                  'Swimming', 'Badminton', 'Sailing', 'Gymanstics', 'Art Competitons',
    ...
    sport_list.insert(0, 'Overall')
    selected_sport = st.selectbox('Select a sport', sport_list)
    temp_df = helper.weigth_v_height(df,selected_sport)
    fig,ax = plt.subplots()
